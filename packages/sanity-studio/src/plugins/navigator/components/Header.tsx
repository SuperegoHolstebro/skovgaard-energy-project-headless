...
const Header = ({ pages, domRef, children }: HeaderProps): JSX.Element => {
  ...
  return (
    <>
      <Card ref={domRef} borderBottom paddingX={1} paddingTop={3} paddingBottom={1} flex={1}>
...
function MenuItem(props: {
  ...
  const slugField =
    schemaType?.jsonType === 'object'
      ...
      : null
  const slugCurrentInitialValue: string | undefined = slugField?.type.initialValue?.current
