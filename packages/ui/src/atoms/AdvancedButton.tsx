...
const advancedButton_Variants = cva(
  'group/advancedbutton inline-flex items-center gap-4 justify-center cursor-pointer rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50', // whitespace-nowrap
  {
    variants: {
      variant: {
        ...
        default: 'px-6 py-2 bg-secondary rounded text-regular justify-center items-center inline-flex text-skovgaard-white transition-colors border border-secondary hover:bg-secondary/0 hover:text-secondary active:bg-secondary active:text-skovgaard-white',
        destructive:
