...
function Portrait({ employee }: any) {
  return (
    <div className="relative object-cover w-full overflow-hidden rounded-md">
      ...
      {employee.socials && (
        <div className="absolute z-10 flex flex-col gap-2 right-2 bottom-2">
          {employee.socials.map((social: any, index: number) => (
  ...
  return (
    <div className="mt-4">
      ...
      <div className="mt-1.5">
        {employee.employeePosition.stilling.map((position: any, index: number) => (
