  ...
  return (
    <button
      ...
      after:absolute after:inset-0 after:size-full after:bg-primary after:hover:rounded after:rounded after:z-10 after:-translate-x-full after:translate-y-0 hover:after:translate-x-0 hover:after:translate-y-0 after:-left-px after:transition-all overflow-hidden after:duration-700 after:ease-custom
       flex items-center justify-between w-full transition-colors  hover:rounded  duration-700 overflow-hidden group-hover:text-skovgaard-white group-hover:prose-headings:!text-skovgaard-white group-hover:prose-p:text-skovgaard-white group-hover:prose-headings:text-skovgaard-white
      "
      onClick={toggle}
    ...
    >
      <span className='z-20 relative'>
        <Heading spacing="none" className="z-10 relative m-0 text-left" tag="h6" size="md" text={'balance'} dangerouslySetInnerHTML={{ __html: children as string }} />
      </span>
      <AccordionIcon />
    </button>
  )
