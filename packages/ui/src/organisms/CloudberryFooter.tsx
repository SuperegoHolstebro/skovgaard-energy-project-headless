...
export default function CloudberryFooter({ logoVariant = 'SkovgaardEnergy' }: FooterProps) {
  ...
  return (
    ...
    >
      ...
      <div className="col-span-full sm:col-span-full md:col-span-6 lg:col-span-4 xl:col-span-8">
        <div className="">
          {/* @ts-ignore */}
          <Link className="" href="https://www.cloudberry.no/" title="">
            <div>
              <Logo variant='Cloudberry' className="md:w-3/4 h-full my-auto" />
            </div>
          </Link>
        </div>
      </div>
      ...
      <div className="space-y-6 col-span-full">
        ...
        <div className="flex flex-col justify-between gap-1 text-center sm:text-left sm:flex-row sm:justify-between text-[14px] text-primary">
...
CloudberryFooter.ColumnOne = ColumnOne
CloudberryFooter.ColumnTwo = ColumnTwo
CloudberryFooter.ColumnThree = ColumnThree
CloudberryFooter.ColumnFour = ColumnFour
CloudberryFooter.Legal = Legal
